...
export type AIProvider = 'OpenAI' | 'Gemini' | 'Groq' | 'Claude' | 'DeepSeek' | 'Mistral' | 'Together' | 'Fireworks' | 'Cohere' | 'Perplexity' | 'OpenRouter' | 'HuggingFace' | 'Replicate' | 'Modal' | 'Anyscale' | 'Ollama' | 'vLLM' | 'LocalAI' | 'LM Studio' | 'GPT4All' | 'Qwen' | 'Yi' | 'Baichuan' | 'Zhipu' | 'Meta LLaMA';

export interface AIModel {
  id: string;
  name: string; // Display name e.g., "Groq Llama 3"
  provider: AIProvider;
  modelId: string; // The actual model string ID e.g., "llama3-8b-8192"
  apiKeys: string[];
